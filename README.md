# Huawei Scan & Account & Game Service Kit (Treasure Hunt Game)
...
This demo project is an example to demonstrate the features of the **Huawei React-Native Scan & Account & Game Service Kit**.
